# Pyarmor 9.2.7 (trial), 000000, 2026-09-02T20:26:48.741655
def __pyarmor__():
    import platform
    import sys
    ...
    def format_system():
        ...
        plat = (
            ...
            if plat.startswith(("freebsd", "openbsd", "isilon onefs"))
            else plat
        )
        if plat == "linux":
    ...
    if plat == "windows" and mach == "x86_64":
        bitness = calcsize(b"P") * 8
        if bitness == 32:
            mach = "x86"
    # mach = 'universal' if plat == 'darwin' else mach
    name = ".".join([f"{plat}_{mach}", "pyarmor_runtime"])
